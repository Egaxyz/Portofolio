...
export default function Footer() {
  return (
    <footer className="bg-[#1f2937] border-t border-gray-700 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h2 className="text-white text-xl font-bold mb-2">Ezio Joestar</h2>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                target="blank"
                className="p-2 rounded-lg bg-[#1f2937] text-gray-400
